<template>
  <form class="identity-form" @submit.prevent="submit">
    ...
    <div class="identity-actions">
      ...
      <button class="identity-cancel" type="button" @click="emit('cancel')">
        Cancel
      </button>
    </div>
  </form>
...
// Verbatim port of the review-widget IntakeForm (labels, validation copy,
// layout) for behavior parity (D042).
