  ...
  <div>
    ...
    <div class="container section faq-grid">
      ...
      <aside class="side-cta">
        ...
        <a class="btn btn--teal" :href="faqPageCopy.sideCta.cta.href">{{ faqPageCopy.sideCta.cta.label }}</a>
      </aside>
    </div>
  </div>
</template>
...
useHead({
  ...
  meta: faq.seo_description ? [{ name: 'description', content: faq.seo_description }] : [],
});
</script>
