...
export function buildPaymentLinkHandoffCopy(): {
  ...
  const customerMessage =
    "I can't create or send a payment link in this chat, and I can't take payment credentials here or in the handoff form. Do not send payment-link details, card details, or bank details here. I can pass the request to the LoanSlam team.";
...
export function buildApprovalStatusHandoffCopy(): {
  ...
  const customerMessage =
    "I can't answer yes or no on whether your application is approved, declined, or still pending in chat. The LoanSlam team can check the status for you.";
