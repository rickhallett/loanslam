...
/**
 * [NODE:hellweek-compare-core]
 * Offline comparison of two Hell Week report artifacts for tuning feedback.
 */
...
/**
 * [NODE:hellweek-compare-from-paths]
 * Loads two report files or run directories and compares normalized reports.
 */
...
/**
 * [NODE:hellweek-compare-reports]
 * Computes aggregate movement and scenario-level failure changes.
 */
...
/**
 * [NODE:hellweek-compare-format]
 * Formats the comparison for pipe-friendly CLI output.
 */
...
/**
 * [NODE:hellweek-compare-normalize-report]
 * Accepts older/newer report shapes and returns the comparison contract.
 */
