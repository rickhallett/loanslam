...
/**
 * [NODE:hellweek-aggregate-core]
 * Converts scenario evidence and grades into the Hell Week report model.
 */
...
/**
 * [NODE:hellweek-build-report]
 * Aggregates safety floor, deflection, routing, UX, and risk summaries.
 */
