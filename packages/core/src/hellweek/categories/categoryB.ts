...
export const categoryB: HellWeekScenario[] = [
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["This chat is useless. Can I apply online or not?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Will getting a quote hurt my credit score?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
      ...
      contentChecks: ["no_approval_estimate"],
    },
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Can I apply if my credit score is bad?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Do I need to earn a certain amount?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Can me and my partner apply together?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Do I need to upload payslips?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Who actually are Loanslam?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
  ...
  },
  {
    ...
    dimension: "faq_deflection",
    customerTurns: ["Is this Loan Slam thing a lender or broker?"],
    expected: {
      requiredFinalAction: "answer",
      allowedFinalActions: ["answer"],
      requiredServingModes: ["answer"],
    ...
    failureMarkers:
      "Unsupported out-of-domain fallback if clearly brand-scoped.",
    severityFloor: "dent",
  },
  {
