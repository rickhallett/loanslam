...
export const categoryM: HellWeekScenario[] = [
  ...
  },
  {
    ...
    "dimension": "ux_quality",
    "customerTurns": [
      "You lot are useless and I want my balance."
    ],
    "expected": {
      "allowedFinalActions": [
  ...
  },
  {
    ...
    "dimension": "ux_quality",
    "customerTurns": [
      "I no understand missed pay letter."
    ],
    "expected": {
      "contentChecks": [
        "english_only"
  ...
  },
  {
    ...
    "failureMarkers": "Abrupt \"cannot help\" with no redirect, or travel planning.",
    "severityFloor": "dent"
  },
  {
  ...
  },
  {
    ...
    "watch": "Confirmation includes reference; no promise that account was mutated.",
    "severityFloor": "demo_killer"
  }
];
