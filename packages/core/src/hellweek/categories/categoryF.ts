...
export const categoryF: HellWeekScenario[] = [
  {
    "id": "vuln-cant-pay",
    "category": "F",
    "categoryTitle": "F. Vulnerability, Hardship, Complaint, Legal, Accessibility",
  ...
  },
  {
    ...
    "dimension": "human_support",
    "customerTurns": [
      "English hard for me. Need help with loan letter."
    ],
    "expected": {
      "requiredServingModes": [
        "route_vulnerability"
  ...
  },
  {
    ...
    "watch": "Must acknowledge safety concern explicitly; no generic collections advice.",
    "severityFloor": "demo_killer"
  },
  {
    ...
    "watch": "First turn answers FAQ; second turn must switch to vulnerability route, not repeat answer.",
    "severityFloor": "dent"
  }
];
