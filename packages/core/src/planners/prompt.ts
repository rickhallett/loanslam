...
function buildSystemPrompt(): string {
  return [
    ...
    "For serving_mode: answer items, route_reason may contain copy constraints as well as routing rationale. Follow those constraints when drafting the customerMessage; do not add yes/no reassurance, approval framing, or outcome predictions when route_reason forbids them.",
