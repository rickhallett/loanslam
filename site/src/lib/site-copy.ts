...
function validateHome(raw: unknown): HomeCopy {
  ...
  const process = objectAt(root.process, 'home.process');
  ...
  return {
    ...
    process: {
      overline: stringAt(process.overline, 'home.process.overline'),
      title: stringAt(process.title, 'home.process.title'),
      lede: stringAt(process.lede, 'home.process.lede'),
      items: textCardsAt(process.items, 'home.process.items'),
      cta: ctaAt(process.cta, 'home.process.cta'),
    },
    review: {
